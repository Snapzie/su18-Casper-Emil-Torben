...
Vores spil er skrevet i C\#, hvor at der skabes et projekt til hver class. 
...
Spillet er i praktisk forstand blevet implementeres ved, at det givne directory DIKUArcade indeholder mange forskellige interfaces (eksempelvis IGameState), der giver et krav til, hvilke forskellige methods, alle de objekter som instantieres udfra pågældende interface, skal agere.
Disse interfaces er i vores kode blevet implementeret på passende måder.
\end{document}